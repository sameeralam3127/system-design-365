...
([Email Service](021-email-service.md)), APNs/FCM connection management
([Push Notification Platform](022-push-notification-platform.md)), carrier
routing ([SMS Gateway](023-sms-gateway.md)) — and outbound webhooks to customer
endpoints ([Webhook Delivery](063-webhook-delivery.md)). Here those are adapters
...
operator restarting a pod. See [Job Scheduler](065-job-scheduler.md) for the
general case.
...
- **"How do you let users control this?"** See
  [Notification Preferences](070-notification-preferences.md) — category
