...
Link previews and unfurling (URL Preview Service),
QR generation (QR Code Platform), the full analytics
warehouse (Analytics Pipeline), and A/B or
...
Same class of problem, same tools as Distributed Cache.
