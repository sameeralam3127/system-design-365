...
search over history (see Search Engine), broadcast
channels with hundreds of thousands of readers (a pull-based feed problem, see
Live Streaming Chat), and payment or bot
...
> and the message carries a reference. See File Storage.
...
question News Feed answers the opposite way.
...
|---|---|---|---|
| `message_id` | Global | Unique, roughly time-sortable (Snowflake-style, see 058) | References, dedupe across conversations, logs |
...
covered in Live Streaming Chat and
Group Messaging.
