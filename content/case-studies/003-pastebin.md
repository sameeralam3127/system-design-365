...
Collaborative editing (see [Collaborative Editor](037-collaborative-editor.md)),
...
the hot-key section in [Distributed Cache](014-distributed-cache.md).
...
- **"Add full-text search over pastes."** See
  [Search Engine](059-search-engine.md), and note that it converts an abuse
